...
constexpr int CELL_LEN = 20;    // 修改方块的边长，以适应不同的屏幕分辨率
...
public:
    ...
    int scores() const { return mScores; }
...
shared_ptr<ITetromino> TetrominoController::make()
{
    ...
    {
        shuffle(mTetrominoCreators.begin(), mTetrominoCreators.end(), mt19937(random_device()()));
        mIndex = 0;
    }
